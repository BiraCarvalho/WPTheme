...
if ( !function_exists('rosaberardo_post_type_photos') ) {

// Register Custom Post Type
function rosaberardo_post_type_photos() {

	$labels = array(
		'name'                  => _x( 'Fotografias', 'Post Type General Name', 'rosaberardo' ),
		'singular_name'         => _x( 'Fotografia', 'Post Type Singular Name', 'rosaberardo' ),
		'menu_name'             => __( 'Fotografias', 'rosaberardo' ),
		'name_admin_bar'        => __( 'Fotografia', 'rosaberardo' ),
	...
	$args = array(
		'label'                 => __( 'Fotografia', 'rosaberardo' ),
		'description'           => __( 'Postagem de Fotografias', 'rosaberardo' ),
		'labels'                => $labels,
...
add_action( 'init', 'rosaberardo_post_type_photos', 0 );
